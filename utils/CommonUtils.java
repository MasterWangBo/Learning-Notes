...
public class CommonUtils {
    ...
    public static <T> T GsonFromJsonToBean(String json, Class<T> classOfT) {
        Gson gson = new GsonBuilder()
                .registerTypeAdapterFactory(new CommonUtils.NullStringToEmptyAdapterFactory())
                .create();
     ...
     * @param phone
     */
    public static void saveTel(Context context, String name, String email, String mobile, String
            phone) {
    ...
    public static void getPermissions(final Activity activity, final String permission) {
        if (Build.VERSION.SDK_INT >= 23) {
            int checkPermission = activity.checkSelfPermission(permission);
            if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                if (activity.shouldShowRequestPermissionRationale(permission)) {
                    activity.requestPermissions(new String[]{permission},
                            REQUEST_CODE_ASK_PERMISSIONS);
                } else {
                    new AlertDialog.Builder(activity).setMessage(R.string
